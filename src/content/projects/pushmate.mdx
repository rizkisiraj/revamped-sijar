...
type: 'ios'
year: 2025
description: 'Push up correcter app with the help of Vision'
cover: /covers/Pushmate.webp
# No demo/screenshot assets yet — drop files in public/projects/pushmate/
# then add `demo:` and `screenshots:` here (see aiget.mdx for the shape).
---
