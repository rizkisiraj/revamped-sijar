...
type: 'web'
year: 2024
description: 'Study companion AI website'
cover: /covers/Thinkmate.webp
# No demo video yet — drop one at public/projects/sleepin/demo.mp4 and
# uncomment the three lines below to enable it.
# demo: /projects/sleepin/demo.mp4
# demoCaption: 'Full walkthrough — quiz creation and AI conversation'
# demoType: video
screenshots:
  - /projects/sleepin/screen-1.png
  - /projects/sleepin/screen-2.png
  - /projects/sleepin/screen-3.png
  - /projects/sleepin/screen-4.png
screenshotCaptions:
  - 'Dashboard'
  - 'Quiz builder'
  - 'AI conversation'
